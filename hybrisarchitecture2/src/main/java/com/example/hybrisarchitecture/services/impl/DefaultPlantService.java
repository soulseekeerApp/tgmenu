...
/**
 * This its a service here its where we add logic to the method we declared in
 * the @PlantService interface
 * 
 * @author KC
 *
 */
...
public class DefaultPlantService implements PlantService {
	/**
	 * This its a dependecy for a plantDao object we need it because our service
	 * need to interact wiht database so we add it here and spring will inject
	 * it to us
	 */
